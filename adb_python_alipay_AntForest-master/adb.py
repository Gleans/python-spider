...
def main():
    ...
    def backback():
        # 返回
        print("返回backback")
        r = os.popen('adb -s 3HX5T17805008293 shell input keyevent 4', 'r', 1)
        print(r)
        time.sleep(1)
        # 返回
        os.popen('adb -s 3HX5T17805008293 shell input keyevent 4', 'r', 1)
        time.sleep(1)
        # 返回
        os.popen('adb -s 3HX5T17805008293 shell input keyevent 4', 'r', 1)
        time.sleep(1)
    ...
    def manyclick():
        ...
        for myx in range(229, 804, 50):
            for myy in range(439, 736, 50):
                myxstr = str(myx)
                myystr = str(myy)
                os.popen('adb -s 3HX5T17805008293 shell input tap ' + myxstr + ' ' + myystr, 'r', 1)
                # print(myxstr +' , '+myystr)
                time.sleep(0.05)
        print("get g")
        # 点击左下一点
        os.popen('adb -s 3HX5T17805008293 shell input tap 259 946', 'r', 1)
        time.sleep(0.1)
        # 点击右下一点
        os.popen('adb -s 3HX5T17805008293 shell input tap 883 774', 'r', 1)
        time.sleep(0.1)
        # 点击右下一点
        os.popen('adb -s 3HX5T17805008293 shell input tap 883 890', 'r', 1)
        time.sleep(1)
        # 返回
        os.popen('adb -s 3HX5T17805008293 shell input keyevent 4', 'r', 1)
        time.sleep(4)
    ...
    def openalipay():
        ...
        time.sleep(0.5)
        # 去点击
        os.popen('adb -s 3HX5T17805008293 shell input keyevent 3', 'r', 1)
        time.sleep(2)
        # 打开alipay
        os.popen('adb -s 3HX5T17805008293 shell input tap 135 250', 'r', 1)
        time.sleep(4)
        # 首页
        os.popen('adb -s 3HX5T17805008293 shell input tap 108 2222', 'r', 1)
        time.sleep(4)
        # 向下滑动
        os.popen('adb -s 3HX5T17805008293 shell input swipe 520 300 520 1000')
        time.sleep(7)
        # 打开蚂蚁
        ...
        try:
            ...
            if matchImg('phoneScreencap.png', 'antIcon.png') is not None:
                ...
                os.popen('adb -s 3HX5T17805008293 shell input tap ' + myx + ' ' + myy, 'r', 1)
                time.sleep(4)
                # 采集
                manyclick()
                time.sleep(4)
    ...
    def screencap():
        try:
            # 截图
            os.popen('adb -s 3HX5T17805008293 shell screencap -p /storage/emulated/0/Pictures/Screenshots/phoneScreencap.png')
            time.sleep(3)
            print("截图")
            # 发送到电脑
            os.popen('adb -s 3HX5T17805008293 pull /storage/emulated/0/Pictures/Screenshots/phoneScreencap.png')
            time.sleep(5)
        except Exception as e:
            print(e)
            print("这里有个异常adb -s 3HX5T17805008293 shell screencap")
    ...
    def doit():
        ...
        try:
            ...
            # 滑动
            os.popen('adb -s 3HX5T17805008293 shell input swipe  520 1300 520 200')
            time.sleep(3)
    ...
    # 刷宝
    def shuabao():
        os.popen('adb -s 3HX5T17805008293 shell input tap 100 2222', 'r', 1)
    ...
    # def kuaikandian():
    #     # 点击左下角的刷新按钮
    #     os.popen('adb -s 3HX5T17805008293 shell input tap 107 2222', 'r', 1)
    #     print("快看点_点击左下角的刷新按钮")
    #     time.sleep(3)
    #     # 向下滑动
    #     os.popen('adb -s 3HX5T17805008293 shell input swipe 520 1000 520 300 ')
    #     time.sleep(6)
    #     # 截图
    #     screencap()
    #     print("快看点_截图")
    ...
    def openWeibo():
        ...
        time.sleep(2)
        # 打开weibo
        os.popen('adb -s 3HX5T17805008293 shell input tap 125 607', 'r', 1)
        time.sleep(7)
        # 点击发现
        os.popen('adb -s 3HX5T17805008293 shell input tap 552 2212', 'r', 1)
        time.sleep(4)
        # 再一次点击发现
        os.popen('adb -s 3HX5T17805008293 shell input tap 552 2212', 'r', 1)
        time.sleep(4)
        # 点击搜索框
        os.popen('adb -s 3HX5T17805008293 shell input tap 552 155', 'r', 1)
        time.sleep(2)
        # 点击最近的一次搜索文字
        os.popen('adb -s 3HX5T17805008293 shell input tap 552 311', 'r', 1)
        time.sleep(5)
        # 点击实时
        os.popen('adb -s 3HX5T17805008293 shell input tap 406 286', 'r', 1)
        time.sleep(5)
    ...
    def Weibo_zan():
        ...
        try:
            ...
            if matchImg('phoneScreencap.png', 'comment.png') is not None:
                ...
                if matchImg('phoneScreencap.png', 'baidulogo.png') is not None:
                    ...
                    time.sleep(2)
                    # 百度输入法 -- 懒人短语
                    os.popen('adb -s 3HX5T17805008293 shell input tap 680 1663', 'r', 1)
                    time.sleep(1)
                    # 百度输入法 -- 懒人短语 -- 点击我的话
                    os.popen('adb -s 3HX5T17805008293 shell input tap 428 1713', 'r', 1)
                    time.sleep(2)
                    # 百度输入法 -- 键盘随便一个字母
                    ...
                    time.sleep(2)
                    # 百度输入法 -- 回车
                    os.popen('adb -s 3HX5T17805008293 shell input tap 974 2150', 'r', 1)
                    time.sleep(1)
                    # 百度输入法 -- 懒人短语 -- 发送
                    os.popen('adb -s 3HX5T17805008293 shell input tap 988 1253', 'r', 1)
                    time.sleep(2)
                    # goback()
                    ...
                    print("评论comment2：")
                    # 点击底部的评论按钮
                    os.popen('adb -s 3HX5T17805008293 shell input tap 513 2212', 'r', 1)
                    time.sleep(3)
                    # 百度输入法
                    os.popen('adb -s 3HX5T17805008293 shell input tap 87 1463', 'r', 1)
                    time.sleep(2)
                    # 百度输入法 -- 懒人短语
                    os.popen('adb -s 3HX5T17805008293 shell input tap 680 1663', 'r', 1)
                    time.sleep(1)
        ...
        for i in range(1, 4):
            ...
            if matchImg('phoneScreencap.png', 'search.png') is not None:
                ...
                # 向下滑动
                print("向下滑动")
                os.popen('adb -s 3HX5T17805008293 shell input swipe 361 1700 361 1400')
                time.sleep(2)
            else:
                print('不是预计的界面，要返回了')
                goback()
        ...
        # 向下滑动
        print("向下滑动")
        os.popen('adb -s 3HX5T17805008293 shell input swipe 361 1700 361 1000')
        time.sleep(2)

    # 模拟滑动
    def initlocal():
        time.sleep(2)  # 滑动前休息2秒，避免网络不好
        os.system('adb -s 3HX5T17805008293 shell input swipe 900 1200 900 500')  # 模拟从下往上滑动
        time.sleep(2)  # 滑动后休息2秒，避免开始计时延迟

    # 返回上一页面
    def goback():
        os.system('adb -s 3HX5T17805008293 shell input keyevent KEYCODE_BACK')  # 返回
        print('返回')
    ...
    def shuabao_money():
        ...
        # 打开刷宝
        print("打开刷宝")
        os.popen('adb -s 3HX5T17805008293 shell input tap 337 267', 'r', 1)
        time.sleep(5)
        # 点击“我”
        print("点击“我”")
        os.popen('adb -s 3HX5T17805008293 shell input tap 983 2195', 'r', 1)
        time.sleep(5)
        os.popen('adb -s 3HX5T17805008293 shell input tap 983 2195', 'r', 1)
        time.sleep(5)
        goback()
        ...
        # 点击当前余额
        print("点击当前余额")
        os.popen('adb -s 3HX5T17805008293 shell input tap 629 840', 'r', 1)
        time.sleep(5)
        # 点击提现
        print("# 点击提现")
        os.popen('adb -s 3HX5T17805008293 shell input tap 926 442', 'r', 1)
        time.sleep(5)
        # 点击0.31
        print("# 点击0.31")
        os.popen('adb -s 3HX5T17805008293 shell input tap 852 825', 'r', 1)
        time.sleep(5)
        # 点击立即提现
        print("# 点击立即提现")
        os.popen('adb -s 3HX5T17805008293 shell input tap 509 2185', 'r', 1)
        time.sleep(5)
        # 返回好多次
        print("# 返回好多次")
        backback()
        ...
        # 点击“任务”
        print("点击“任务”")
        os.popen('adb -s 3HX5T17805008293 shell input tap 747 2222', 'r', 1)
        time.sleep(3)
        # 点击“任务”
        print("点击“任务”")
        os.popen('adb -s 3HX5T17805008293 shell input tap 747 2222', 'r', 1)
        ...
        # 点击“关闭小窗口”
        print("点击“关闭小窗口”")
        os.popen('adb -s 3HX5T17805008293 shell input tap 867 712', 'r', 1)
        time.sleep(3)
        # 点击“立即签到”
        print("点击立即签到")
        os.popen('adb -s 3HX5T17805008293 shell input tap 896 541', 'r', 1)
        time.sleep(2)
        # 点击“立即签到”
        print("点击立即签到")
        os.popen('adb -s 3HX5T17805008293 shell input tap 896 541', 'r', 1)
        ...
        # 点击“看视频”
        print("看视频")
        os.popen('adb -s 3HX5T17805008293 shell input tap 737 1528', 'r', 1)
        time.sleep(33)
        # 关掉视频”
        print("关掉视频”")
        os.popen('adb -s 3HX5T17805008293 shell input tap 978 170', 'r', 1)
        time.sleep(2)
        # 关掉视频”
        print("关掉视频”")
        os.popen('adb -s 3HX5T17805008293 shell input tap 978 170', 'r', 1)
    ...
    def kuaikandian_money():
        ...
        backback()
        # 打开快看点
        os.popen('adb -s 3HX5T17805008293 shell input tap 957 260', 'r', 1)
        time.sleep(7)
        # 点击任务
        print("点击任务")
        os.popen('adb -s 3HX5T17805008293 shell input tap 963 2202', 'r', 1)
        time.sleep(3)
        # 点击任务
        print("点击任务")
        os.popen('adb -s 3HX5T17805008293 shell input tap 963 2202', 'r', 1)
        ...
        # 点击我的金币
        print("点击我的金币")
        os.popen('adb -s 3HX5T17805008293 shell input tap 126 437', 'r', 1)
        time.sleep(5)
        # 点击去提现
        print("点击去提现")
        os.popen('adb -s 3HX5T17805008293 shell input tap 930 453', 'r', 1)
        time.sleep(3)
        # 点击提现
        print("点击提现长按钮")
        os.popen('adb -s 3HX5T17805008293 shell input tap 568 2205', 'r', 1)
        time.sleep(6)
        print("点击提现长按钮")
        os.popen('adb -s 3HX5T17805008293 shell input tap 568 2205', 'r', 1)
        time.sleep(6)
        # 点击绿色的按钮提现
        print("点击绿色的按钮提现")
        os.popen('adb -s 3HX5T17805008293 shell input tap 553 739', 'r', 1)
        time.sleep(6)
        # 返回好多次
        backback()
        # home
    ...
    while 1 == 1:
        ...
        # 支付宝
        if (mytime.hour == 7) or (mytime.hour == 8) or (mytime.hour == 9) or (mytime.hour == 22):
            # 判断是不是第一次运行
            print("判断是不是第一次运行")
            # print(firsttime)
            # if firsttime == 1:
